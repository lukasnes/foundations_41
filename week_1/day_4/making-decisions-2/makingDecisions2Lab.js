...
console.log(`The last item in the array was ${lastItemRemoved}`)
console.log(`The arr now contains ${arr}`)
...
console.log(`The evens in the array were ${evensArr}`)
...
console.log(`The fifth value in myFavoriteNumbers is ${someNum}`)
////////// PROBLEM 7 //////////
...
//Code Here
// myFavoriteNumbers[10] = 79
// console.log(myFavoriteNumbers[8])
