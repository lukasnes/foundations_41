...
//Code Here
let myFirstVehicle = new Vehicle(4,'blue',6000)
...
let myFirstMotorcycle = new Motorcycle(2,"black",5000,"kawasaki", true)
...
class Boat extends Vehicle{
  ...
  checkSeaworthiness(){
    if(this.isSeaworthy === true){
      ...
      console.log(`get your ${this.type} in shape!`)
    }
  }
  performMaintenance(){
...
let myBoat = new Boat(6,'red',200,'Wave Crasher', 'dingy', false)
